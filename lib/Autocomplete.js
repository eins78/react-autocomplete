...
class Autocomplete extends React.Component {
  ...
  maybeScrollItemIntoView() {
    if (this.isOpen() && this.state.highlightedIndex !== null) {
      const itemNodeRef = this.refs[`item-${this.state.highlightedIndex}`]
      const menuNodeRef = this.refs.menu
      const itemNode = findDOMNode(itemNodeRef)
      const menuNode = findDOMNode(menuNodeRef)
